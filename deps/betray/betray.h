...
extern void		betray_requester_save(char **types, uint type_count); /* launches a requester to save something */
extern void		betray_requester_load(char **types, uint type_count); /* launches ar equester to load something*/
extern char		*betray_requester_save_get(void); /* Returns a path from the save requester */
extern char		*betray_requester_load_get(void); /* Returns a path from the load requester */
...
extern void		betray_get_current_time(uint32 *seconds, uint32 *fractions); /*  get time in seconds and fractions of seconds */
...
extern uint		betray_audio_stream_buffer_left(uint stream, uint sound); /* unload sound data */
