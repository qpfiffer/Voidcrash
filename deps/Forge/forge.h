...
extern void f_cross2f(float *output, float *a); /* Computes cross product of a point in 2D for 32 bit floats.*/
extern void f_cross3f(float *output, float *a, float *b); /* Computes cross product between two points in 3D for 32 bit floats.*/
extern void f_surface_cross2f(float *output, float *a, float *subtract); /* Computes cross product between two points in 2D for 64 bit doubles.*/
extern void f_surface_cross3f(float *output, float *a, float *b, float *subtract); /* Computes cross product between three points in 3D for 64 bit doubles.*/
...
extern void f_cross2d(double *output, double *a); /* Computes cross product of a point in 2D for 64 bit doubles.*/
extern void f_cross3d(double *output, double *a, double *b); /* Computes cross product between two points in 3D for 64 bit doubles.*/
extern void f_surface_cross2d(double *output, double *a, double *subtract); /* Computes cross product between two points in 2D for 64 bit doubles.*/
extern void f_surface_cross3d(double *output, double *a, double *b, double *subtract); /* Computes cross product between three points in 3D for 64 bit doubles.*/
...
extern float *f_image_scale_float(float *data, unsigned int in_x, unsigned int in_y, unsigned int out_x, unsigned int out_y, unsigned int channels, unsigned int line_padding);
extern unsigned char *f_image_scale_uint8(unsigned char *data, unsigned int in_x, unsigned int in_y, unsigned int out_x, unsigned int out_y, unsigned int channels, unsigned int line_padding);
...
extern boolean	f_text_filter_nocaps(char *text, char *filter);
