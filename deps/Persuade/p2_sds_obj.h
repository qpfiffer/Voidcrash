...
extern void		p_lod_compute_vertex_array(pgreal *vertex, uint vertex_count, const uint *ref_count, const uint *reference,  const pgreal *weight, const pgreal *cvs);
extern void		p_lod_compute_normal_array(pgreal *normals, uint vertex_count, const uint *normal_ref, const pgreal *vertex);
